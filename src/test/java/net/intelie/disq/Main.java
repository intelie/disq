...
public class Main {
    ...
    private static ObjectQueue<String> open() throws IOException {
        DiskRawQueue bq = new DiskRawQueue(Paths.get("/home/juanplopes/Downloads/queue"), 1024 * 1024 * 1024, true, true, false);
        return new ObjectQueue<>(bq, new DefaultSerializer<>(), 2000, -1, true);
    }
