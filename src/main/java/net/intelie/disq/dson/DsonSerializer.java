...
public class DsonSerializer implements Serializer<Object>, SerializerFactory<Object> {
    @Override
    ...
    private Object deserialize(Buffer.InStream stream) throws IOException {
        switch (DsonBinaryRead.readType(stream)) {
            ...
            case STRING:
                UnicodeView unicodeView = new UnicodeView();
                DsonBinaryRead.readUnicode(stream, unicodeView);
                return unicodeView.toString();
            case STRING_LATIN1:
                Latin1View latin1View = new Latin1View();
